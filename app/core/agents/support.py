...
class SupportAgent(BaseAgent):
    ...
    async def process(self, message: str, user_id: str, context: Optional[Dict[str, Any]] = None) -> AgentResponse:
        self.logger.info(f"Processing support request for user {user_id}: {message[:100]}...")
